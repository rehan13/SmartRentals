export default function Perks({selected, onChange}){
    return (
        ...
        <div className="grid mt-2 gap-2 grid-cols-2 md:grid-cols-3 lg:grid-cols-9">
                            ...
                            <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                                <input type="checkbox"/>
                                <svg version="1.1" id="Uploaded to svgrepo.com" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" className="size-6" viewBox="0 0 32 32" xml:space="preserve">
                                    <path class="feather_een" d="M16,25.092V9.5C16,9.224,15.776,9,15.5,9S15,9.224,15,9.5v15.592c-0.581,0.207-1,0.756-1,1.408
                            ...
                            <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                                ...
                                <svg fill="#000000" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                                    className="size-5" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve">
                                <g>
