export default function Perks({selected, onChange}){
    ...
    return (
        ...
        <div className="grid mt-2 gap-2 grid-cols-2 md:grid-cols-3 lg:grid-cols-9">
                            ...
                            <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                                <input type="checkbox" name="Air Condition" onChange={handleCheckBoxClick}/>
                            ...
                            <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                                <input type="checkbox" name="Heater" onChange={handleCheckBoxClick}/>
                            ...
                            <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                                <input type="checkbox" name="Hot Water" onChange={handleCheckBoxClick}/>
                            ...
                            <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                                <input type="checkbox" name="Fire Alarm" onChange={handleCheckBoxClick}/>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                            ...
                            <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                                <input type="checkbox" name="First Aid" onChange={handleCheckBoxClick}/>
                            ...
                            <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                                <input type="checkbox" name="Pets Friendly" onChange={handleCheckBoxClick}/>
